...
<body>
    ...
    <section>
        <header>
            <h3 class="cs-1">1:1 문의</h3>
        </header>
        <div class="content">
    										<!-- 컨트롤러 webServlet의 경로를 맞춰야 한다 ... 보내려는 곳 .. 그쪽으로 가야 짜놓은 로직이 실행됨 -->
            <form method="post" action="<%=request.getContextPath()%>/mypage/qna" enctype="multipart/form-data">
                <div class="fields">
                    <div class="field half">
                        <label for="name">제목</label>
                        <input type="text" name="qnaTitle" id="name" value="">
                    </div>
                   
                    <div class="field third">
                        <input type="radio" id="priority-low" name="qnaCat" value="회원관련">
                        <label for="priority-low">회원관련</label>
                    </div>
                    <div class="field third">
                        <input type="radio" id="priority-normal" name="qnaCat" value="일정관련">
                        <label for="priority-normal">일정관련</label>
                    </div>
                    <div class="field third">
                        <input type="radio" id="priority-high" name="qnaCat" value="기록관련">
                        <label for="priority-high">기록관련</label>
                    </div>
                     <div class="field third">
                        <input type="radio" id="priority-high" name="qnaCat" value="기타문의">
                        <label for="priority-high">기타문의</label>
                    </div>
                   
                    <div class="field">
                        <label for="message">문의내용</label>
                        <textarea name="qnaCn" id="message" rows="6"></textarea>
                    </div>
                ...
                <ul class="actions">
					<li><input type="hidden" name="memId" value="<%=mv.getMem_Id()%>"></li>                
