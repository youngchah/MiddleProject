...
public class CcomVO {
	...
	/*
	 * public ComVO(String city_name, String com_title, String com_cn) { // TODO
	 * Auto-generated constructor stub }
	 */

	public CcomVO(String com_title, String com_regi, String mem_nick) {
		super();
	...
	public String getCom_delyn() {
		return com_delyn;
	}

	public void setCom_delyn(String com_delyn) {
		this.com_delyn = com_delyn;
	}
