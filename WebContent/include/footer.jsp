...
<div id="city_sidebar" class="city_sidebar">
    <!-- 특별시 -->
   <span onclick="showSubCategories('special_city')" style="cursor: pointer;">특별시 광역시</span>
		 <br>
    ...
    <!-- 경기도 -->
    <br>
    <span onclick="showSubCategories('gyeonggi_province')" style="cursor: pointer;">경기도</span> <br>
    ...
    <!-- 강원특별자치도 -->
    <br>
    <span onclick="showSubCategories('gangwon_province')" style="cursor: pointer;">강원특별자치도</span> <br>
    ...
    <!-- 충청북도 -->
    <br>
	<span onclick="showSubCategories('chungbuk_province')" style="cursor: pointer;">충청북도</span> <br>
   ...
   <!-- 충청남도 -->
   <br>
	<span onclick="showSubCategories('chungnam_province')" style="cursor: pointer;">충청남도</span> <br>
    ...
    <!-- 전라북도특별자치도 -->
    <br>
	<span onclick="showSubCategories('jeollabuk_district')" style="cursor: pointer;">전라북도특별자치도</span> <br>
    ...
    <!-- 전라남도 -->
    <br>
 <span onclick="showSubCategories('jeonnam_province')" style="cursor: pointer;">전라남도</span> <br>
	...
	<!-- 경상북도 -->
	<br>
	<span onclick="showSubCategories('gyeongbuk_province')" style="cursor: pointer;">경상북도</span> <br>
	...
	<!-- 경상남도 -->
	<br>
	<span onclick="showSubCategories('gyeongnam_province')" style="cursor: pointer;">경상남도</span> <br>
	...
	<!-- 제주특별자치도 -->
	<br>
	<span onclick="showSubCategories('jeju_province')" style="cursor: pointer;">제주특별자치도</span> <br>
